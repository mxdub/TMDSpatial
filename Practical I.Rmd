...
Some ordination methods works on _raw_ data (eventually transformed - e.g., Hellinger transformed) (e.g., (constrained) Canonical Analysis, rda), whereas other works on distances (e.g., PCoA, dbRDA).
...
Variance explained (adjusted-R2) by each fractions are presented in the output from varpart(), and displayed in the plot. 
...
+ Dispersal component : slow vs. quick decrease rate of disp. kernel 'kernel_exp' (0.001 vs. 0.2) 
